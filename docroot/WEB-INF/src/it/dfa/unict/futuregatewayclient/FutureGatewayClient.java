package it.dfa.unict.futuregatewayclient;
...
public class FutureGatewayClient {
	...
	public FutureGatewayClient(String fgHost, int fgPort, String fgAPIVersion) {
		...
		this.apiResource = this.client.resource(this.fgEndpoint + "/"
				+ this.fgApiversion);
	}
	...
	public Task createTask(AppInput appInput, String user)
		...
		if (response.getStatus() != Response.Status.OK.getStatusCode()) {
			throw new FutureGatewayClientException(
	...
	public Task getTask(int id) throws FutureGatewayClientException {
